...
// Definisce una route GET per l'endpoint '/dbusers'
// Quando un client effettua una richiesta GET a questo endpoint, viene invocata la funzione 'usersFromDB' del controller 'usersController'
...
// Definisce una route GET per l'endpoint "/api/users"
app.get('/api/users', (req, res) => {
  
  // Importa i dati degli utenti dal file JSON
  const users = require('./data/users.json');
  
  // Invia i dati degli utenti come risposta in formato JSON
  res.json(users);
});
